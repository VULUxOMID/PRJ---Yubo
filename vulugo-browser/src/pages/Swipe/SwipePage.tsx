      ...
      <div className="bg-white border-t border-gray-200 px-4 py-6">
        <div className="flex items-center justify-center space-x-6">
          <button
            ...
            className="w-14 h-14 bg-white border-2 border-gray-300 rounded-full flex items-center justify-center hover:border-gray-400 transition-colors shadow-lg"
          >
          ...
          <button
            ...
            className="w-14 h-14 bg-primary-500 rounded-full flex items-center justify-center hover:bg-primary-600 transition-colors shadow-lg"
          >
